...
@test "install from directory" {
  ...
  # verify add-on crawl
  ddev exec "curl --location --request POST 'https://test-ddev-a11ywatch-standalone.ddev.site:3280/api/crawl' --header 'Content-Type: application/json' --header 'Transfer-Encoding: chunked' --data-raw '{ 'url': 'https://a11ywatch.com' }'"
}
